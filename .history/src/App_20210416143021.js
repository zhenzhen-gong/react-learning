     ...
     return (
       <div className="context">
         ...
         <form className="form-submit" onSubmit={this.handleSubmit}>
           <input type="text" value={this.state.person} onChange={this.handlePerson}></input>
           <div>
             <input type="radio" value='1' checked={this.state.sex===1} onClick={this.handleSex}>男</input>
             <input type="radio" value='2' checked={this.state.sex===2} onClick={this.handleSex}>女</input>
           </div>
         </form>
       </div>
     )
